...
if __name__ == '__main__':
    ...
    print(f"Средняя цена в категории {category1.name}: {category1.average_price()} руб.")

    category_empty = Category("Пустая категория", "Категория без продуктов", [])
    print(f"Средняя цена в категории {category_empty.name}: {category_empty.average_price()} руб.")